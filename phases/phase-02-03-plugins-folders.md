...
- `✅ To-dos/` — **ONLY if they want task management inside the vault.** Some people prefer external tools (Todoist, Things, Linear). If they say yes or mention wanting to track tasks: create the folder, then install the to-do system from `templates/generated/todo-system-template.md`. This gives them a prioritized task list (P1/P2/P3 tiers with Dataview inline fields), an auto-refreshing This Week view, and a Waiting On tracker. If they already have a task system they like, skip it.
