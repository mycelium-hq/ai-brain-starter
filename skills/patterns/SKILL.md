---
name: patterns
description: Instinct Engine — scans recent sessions, journals, and decisions for recurring patterns and turns them into concrete captures (Originals/, CLAUDE.md rules, concept notes, skill improvements). Run after /weekly or whenever you sense a pattern hardening.
trigger: /patterns
---
...
- Any content drafts file — recent drafts (look for recurring metaphors)
- `[VAULT]/Originals/` — files created in the last 30 days (avoid duplicating)
...
**Decision frameworks** — Are there repeating decision types where the same logic applies each time? (e.g., "When [X], I always choose [Y] because [Z]") These should be rules or Originals captures.
...
> **Writing pattern:** "[exact quote]" has appeared in 3 entries and 2 drafts in the last 2 weeks. Not yet captured in Originals/.
> → Proposed: capture to `Originals/[File Name].md`
...
- **Originals/ capture** → write the file with exact phrasing (never paraphrase). Update Wikilink Reference.md if one exists.
